...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _metamask_onboarding__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @metamask/onboarding */ "./node_modules/@metamask/onboarding/dist/metamask-onboarding.es.js");
...
var initialize = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var onboardButton, walletAddressEl, input, plusEl, minusEl, maxEl, costEl, dateEl, toalEl, onboarding, setup, formatedDate, isMetaMaskInstalled, accounts, onClickInstall, onClickConnect, MetaMaskClientCheck, sendTransaction, playLoader, stopLoader, notify, parseEther, nftToEth, shortenAddress, changeAmount;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            onboardButton = document.getElementById('connectBtn');
            walletAddressEl = document.getElementById('walletAddress');
            input = document.getElementById('mintnumber');
            ...
            toalEl = document.getElementById('total');
            onboarding = new _metamask_onboarding__WEBPACK_IMPORTED_MODULE_0__["default"]({
              origin: origin
            });
            ...
            formatedDate = function formatedDate() {
              ...
              return "".concat(month, "/").concat(day, "/").concat(fullYear);
            };
          ...
          case 19:
            onClickInstall = function onClickInstall() {
            ...
            MetaMaskClientCheck = /*#__PURE__*/function () {
              ...
              return function MetaMaskClientCheck() {
            ...
            sendTransaction = function sendTransaction() {
              ...
              ethereum.request({
                ...
                notify({
                  text: "Click here to check out your transaction on Etherscan: https://ropsten.etherscan.io/tx/".concat(txHash),
                  destination: "https://ropsten.etherscan.io/tx/".concat(txHash),
                  newWindow: true
                });
                stopLoader();
            ...
            playLoader = function playLoader() {
            ...
            notify = function notify(_ref4) {
              var text = _ref4.text,
                  _ref4$duration = _ref4.duration,
                  duration = _ref4$duration === void 0 ? 10000 : _ref4$duration,
                  _ref4$position = _ref4.position,
                  position = _ref4$position === void 0 ? "center" : _ref4$position,
                  _ref4$background = _ref4.background,
                  background = _ref4$background === void 0 ? "linear-gradient(to right, #00b09b, #96c93d)" : _ref4$background,
            ...
            parseEther = function parseEther(amount) {
              return ethers__WEBPACK_IMPORTED_MODULE_4__.parseEther(amount.toString())._hex;
            };

            nftToEth = function nftToEth(value) {
              return parseFloat((value * parseFloat(COST)).toFixed(10));
            };

            shortenAddress = function shortenAddress(address) {
              return "".concat(address.slice(0, 8), "...").concat(address.slice(address.length - 10));
            };
            ...
            changeAmount = function changeAmount(newval) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/*!\n * Toastify js 1.11.2\n * https://github.com/apvarun/toastify-js\n * @license MIT licensed\n *\n * Copyright (C) 2018 Varun A P\n */\n\n.toastify {\n    padding: 12px 20px;\n    color: #ffffff;\n    display: inline-block;\n    box-shadow: 0 3px 6px -1px rgba(0, 0, 0, 0.12), 0 10px 36px -4px rgba(77, 96, 232, 0.3);\n    background: -webkit-linear-gradient(315deg, #73a5ff, #5477f5);\n    background: linear-gradient(135deg, #73a5ff, #5477f5);\n    position: fixed;\n    opacity: 0;\n    transition: all 0.4s cubic-bezier(0.215, 0.61, 0.355, 1);\n    border-radius: 2px;\n    cursor: pointer;\n    text-decoration: none;\n    max-width: calc(50% - 20px);\n    z-index: 2147483647;\n}\n\n.toastify.on {\n    opacity: 1;\n}\n\n.toast-close {\n    opacity: 0.4;\n    padding: 0 5px;\n}\n\n.toastify-right {\n    right: 15px;\n}\n\n.toastify-left {\n    left: 15px;\n}\n\n.toastify-top {\n    top: -150px;\n}\n\n.toastify-bottom {\n    bottom: -150px;\n}\n\n.toastify-rounded {\n    border-radius: 25px;\n}\n\n.toastify-avatar {\n    width: 1.5em;\n    height: 1.5em;\n    margin: -7px 5px;\n    border-radius: 2px;\n}\n\n.toastify-center {\n    margin-left: auto;\n    margin-right: auto;\n    left: 0;\n    right: 0;\n    max-width: fit-content;\n    max-width: -moz-fit-content;\n}\n\n@media only screen and (max-width: 360px) {\n    .toastify-right, .toastify-left {\n        margin-left: auto;\n        margin-right: auto;\n        left: 0;\n        right: 0;\n        max-width: fit-content;\n    }\n}\n", "",{"version":3,"sources":["webpack://./node_modules/toastify-js/src/toastify.css"],"names":[],"mappings":"AAAA;;;;;;EAME;;AAEF;IACI,kBAAkB;IAClB,cAAc;IACd,qBAAqB;IACrB,uFAAuF;IACvF,6DAA6D;IAC7D,qDAAqD;IACrD,eAAe;IACf,UAAU;IACV,wDAAwD;IACxD,kBAAkB;IAClB,eAAe;IACf,qBAAqB;IACrB,2BAA2B;IAC3B,mBAAmB;AACvB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,cAAc;AAClB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,OAAO;IACP,QAAQ;IACR,sBAAsB;IACtB,2BAA2B;AAC/B;;AAEA;IACI;QACI,iBAAiB;QACjB,kBAAkB;QAClB,OAAO;QACP,QAAQ;QACR,sBAAsB;IAC1B;AACJ","sourcesContent":["/*!\n * Toastify js 1.11.2\n * https://github.com/apvarun/toastify-js\n * @license MIT licensed\n *\n * Copyright (C) 2018 Varun A P\n */\n\n.toastify {\n    padding: 12px 20px;\n    color: #ffffff;\n    display: inline-block;\n    box-shadow: 0 3px 6px -1px rgba(0, 0, 0, 0.12), 0 10px 36px -4px rgba(77, 96, 232, 0.3);\n    background: -webkit-linear-gradient(315deg, #73a5ff, #5477f5);\n    background: linear-gradient(135deg, #73a5ff, #5477f5);\n    position: fixed;\n    opacity: 0;\n    transition: all 0.4s cubic-bezier(0.215, 0.61, 0.355, 1);\n    border-radius: 2px;\n    cursor: pointer;\n    text-decoration: none;\n    max-width: calc(50% - 20px);\n    z-index: 2147483647;\n}\n\n.toastify.on {\n    opacity: 1;\n}\n\n.toast-close {\n    opacity: 0.4;\n    padding: 0 5px;\n}\n\n.toastify-right {\n    right: 15px;\n}\n\n.toastify-left {\n    left: 15px;\n}\n\n.toastify-top {\n    top: -150px;\n}\n\n.toastify-bottom {\n    bottom: -150px;\n}\n\n.toastify-rounded {\n    border-radius: 25px;\n}\n\n.toastify-avatar {\n    width: 1.5em;\n    height: 1.5em;\n    margin: -7px 5px;\n    border-radius: 2px;\n}\n\n.toastify-center {\n    margin-left: auto;\n    margin-right: auto;\n    left: 0;\n    right: 0;\n    max-width: fit-content;\n    max-width: -moz-fit-content;\n}\n\n@media only screen and (max-width: 360px) {\n    .toastify-right, .toastify-left {\n        margin-left: auto;\n        margin-right: auto;\n        left: 0;\n        right: 0;\n        max-width: fit-content;\n    }\n}\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/iconfont.eot?1644181909038 */ "./src/fonts/iconfont.eot?1644181909038"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/iconfont.eot */ "./src/fonts/iconfont.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/iconfont.woff2?1644181909038 */ "./src/fonts/iconfont.woff2?1644181909038"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/iconfont.woff?1644181909038 */ "./src/fonts/iconfont.woff?1644181909038"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/iconfont.ttf?1644181909038 */ "./src/fonts/iconfont.ttf?1644181909038"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___, { hash: "?#iefix-1644181909038" });
var ___CSS_LOADER_URL_REPLACEMENT_2___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_2___);
var ___CSS_LOADER_URL_REPLACEMENT_3___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_3___);
var ___CSS_LOADER_URL_REPLACEMENT_4___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_4___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html,\r\nbody,\r\ndiv,\r\nspan,\r\napplet,\r\nobject,\r\niframe,\r\nh1,\r\nh2,\r\nh3,\r\nh4,\r\nh5,\r\nh6,\r\np,\r\nblockquote,\r\npre,\r\na,\r\nabbr,\r\nacronym,\r\naddress,\r\nbig,\r\ncite,\r\ncode,\r\ndel,\r\ndfn,\r\nem,\r\nimg,\r\nins,\r\nkbd,\r\nq,\r\ns,\r\nsamp,\r\nsmall,\r\nstrike,\r\nstrong,\r\nsub,\r\nsup,\r\ntt,\r\nvar,\r\nb,\r\nu,\r\ni,\r\ncenter,\r\ndl,\r\ndt,\r\ndd,\r\nol,\r\nul,\r\nli,\r\nfieldset,\r\nform,\r\nlabel,\r\nlegend,\r\ntable,\r\ncaption,\r\ntbody,\r\ntfoot,\r\nthead,\r\ntr,\r\nth,\r\ntd,\r\narticle,\r\naside,\r\ncanvas,\r\ndetails,\r\nembed,\r\nfigure,\r\nfigcaption,\r\nfooter,\r\nheader,\r\nhgroup,\r\nmenu,\r\nnav,\r\noutput,\r\nruby,\r\nsection,\r\nsummary,\r\ntime,\r\nmark,\r\naudio,\r\nvideo {\r\n\tmargin: 0;\r\n\tpadding: 0;\r\n\tborder: 0;\r\n\tfont-size: 100%;\r\n\tfont: inherit;\r\n\tvertical-align: baseline;\r\n}\r\n::selection {\r\n\tcolor: none;\r\n\tbackground: 0 0;\r\n}\r\narticle,\r\naside,\r\ndetails,\r\nfigcaption,\r\nfigure,\r\nfooter,\r\nheader,\r\nhgroup,\r\nmenu,\r\nnav,\r\nsection {\r\n\tdisplay: block;\r\n}\r\nbody {\r\n\tline-height: 1;\r\n  max-width: 100%;\r\n}\r\nol,\r\nul {\r\n\tlist-style: none;\r\n}\r\nblockquote,\r\nq {\r\n\tquotes: none;\r\n}\r\nblockquote:before,\r\nblockquote:after,\r\nq:before,\r\nq:after {\r\n\tcontent: \"\";\r\n\tcontent: none;\r\n}\r\ntable {\r\n\tborder-collapse: collapse;\r\n\tborder-spacing: 0;\r\n}\r\n* {\r\n\t-webkit-box-sizing: border-box;\r\n\tbox-sizing: border-box;\r\n}\r\n*::before,\r\n*::after {\r\n\t-webkit-box-sizing: border-box;\r\n\tbox-sizing: border-box;\r\n}\r\n.section-title {\r\n\tfont-size: 32px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.h1,\r\nh1 {\r\n\tfont-size: 68px;\r\n\tline-height: 81px;\r\n\tfont-weight: 700;\r\n\tletter-spacing: 1px;\r\n}\r\n.h2,\r\nh2 {\r\n\tfont-size: 75px;\r\n\tline-height: 82px;\r\n\tfont-weight: 700;\r\n}\r\n.h3,\r\nh3 {\r\n\tfont-size: 28px;\r\n\tline-height: 34px;\r\n\tfont-weight: 700;\r\n}\r\n.h4,\r\nh4 {\r\n\tfont-size: 23px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.h5,\r\nh5 {\r\n\tfont-size: 18px;\r\n\tline-height: 24px;\r\n\tfont-weight: 700;\r\n}\r\n.h6,\r\nh6 {\r\n\tfont-size: 14px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\np {\r\n\tfont-size: 14px;\r\n\tline-height: 22px;\r\n}\r\n.text-small {\r\n\tfont-size: 12px;\r\n\tline-height: 20px;\r\n}\r\n@font-face {\r\n\tfont-family: iconfont;\r\n\tsrc: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\r\n\tsrc: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")\r\n\t\t\tformat(\"embedded-opentype\"),\r\n\t\turl(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"woff2\"),\r\n\t\turl(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"woff\"),\r\n\t\turl(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") format(\"truetype\");\r\n\tfont-weight: 400;\r\n\tfont-style: normal;\r\n}\r\n[class^=\"icon-\"]::before,\r\n[class*=\" icon-\"]::before {\r\n\tfont-family: iconfont;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tline-height: 1;\r\n\tfont-weight: 400;\r\n\tfont-style: normal;\r\n\tspeak: none;\r\n\ttext-decoration: inherit;\r\n\tfont-size: inherit;\r\n\ttext-transform: none;\r\n\ttext-rendering: optimizeLegibility;\r\n\t-webkit-font-smoothing: antialiased;\r\n\t-moz-osx-font-smoothing: grayscale;\r\n}\r\n.icon-discord::before {\r\n\tcontent: \"\\ea01\";\r\n}\r\n.icon-minus::before {\r\n\tcontent: \"\\ea02\";\r\n}\r\n.icon-plus::before {\r\n\tcontent: \"\\ea03\";\r\n}\r\n.icon-twitter::before {\r\n\tcontent: \"\\ea04\";\r\n}\r\n.icon-instagram::before {\r\n\tcontent: \"\\ea04\";\r\n}\r\n.mint__container::before,\r\n.mint__number::before,\r\n.mint__container::after,\r\n.mint__number::after {\r\n\tcontent: \"\";\r\n\tdisplay: table;\r\n}\r\n.mint__container::after,\r\n.mint__number::after {\r\n\tclear: both;\r\n}\r\n.wrapper {\r\n\twidth: 100%;\r\n\tmax-width: 1065px;\r\n\tpadding: 0 20px;\r\n\tmargin: 0 auto;\r\n}\r\n.has-cover {\r\n\tbackground-repeat: no-repeat;\r\n\tbackground-size: cover;\r\n\tbackground-position: center center;\r\n}\r\n.sr-only {\r\n\tborder: 0 !important;\r\n\tclip: rect(1px, 1px, 1px, 1px) !important;\r\n\t-webkit-clip-path: inset(50%) !important;\r\n\tclip-path: inset(50%) !important;\r\n\theight: 1px !important;\r\n\tmargin: -1px !important;\r\n\toverflow: hidden !important;\r\n\tpadding: 0 !important;\r\n\tposition: absolute !important;\r\n\twidth: 1px !important;\r\n\twhite-space: nowrap !important;\r\n}\r\n.sr-only-focusable:focus,\r\n.sr-only-focusable:active {\r\n\tclip: auto !important;\r\n\t-webkit-clip-path: none !important;\r\n\tclip-path: none !important;\r\n\theight: auto !important;\r\n\tmargin: auto !important;\r\n\toverflow: visible !important;\r\n\twidth: auto !important;\r\n\twhite-space: normal !important;\r\n}\r\nbody {\r\n\tmargin: 0;\r\n\tpadding: 0;\r\n\tfont-family: lexend deca, sans-serif;\r\n\tfont-weight: 400;\r\n\tposition: relative;\r\n\theight: 100vh;\r\n\twidth: 100vw;\r\n\tcolor: #fff;\r\n}\r\n@media only screen and (min-width: 120px) and (max-width: 767px) {\r\n\tbody {\r\n\t\theight: 130vh;\r\n\t}\r\n}\r\nbody::after {\r\n\tcontent: \"\";\r\n\tposition: absolute;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tbackground-color: rgba(0, 0, 0, 0.6);\r\n\tz-index: -1;\r\n}\r\np {\r\n\tcolor: #000;\r\n}\r\n[class*=\"icon-\"] {\r\n\tdisplay: inline-block;\r\n}\r\n.container {\r\n\ttext-align: center;\r\n\tposition: absolute;\r\n\ttop: 50%;\r\n\tleft: 50%;\r\n\t-webkit-transform: translate(-50%, -50%);\r\n\ttransform: translate(-50%, -50%);\r\n\twidth: 100%;\r\n}\r\n.container__list {\r\n\tfont-size: 0;\r\n\tmargin-bottom: 20px;\r\n}\r\n.container__list-item {\r\n\tmargin: 0 10px;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n}\r\n.container__list-link {\r\n\tdisplay: inline-block;\r\n\tpadding: 3px;\r\n}\r\n.container__list-img {\r\n\theight: 30px;\r\n}\r\n.icon-twitter,\r\n.icon-discord {\r\n\tfont-size: 30px;\r\n\tline-height: 35px;\r\n\tcolor: #fff;\r\n}\r\n.mint {\r\n\tmargin: 0 auto;\r\n\ttext-align: left;\r\n\tbackground-color: rgba(0, 0, 0, 0.5);\r\n\t-webkit-backdrop-filter: blur(16px);\r\n\tbackdrop-filter: blur(16px);\r\n\tborder-radius: 10px;\r\n\tmax-width: 425px;\r\n\tpadding: 32px;\r\n}\r\n.mint__title {\r\n\tfont-size: 32px;\r\n\tline-height: 35px;\r\n\tmargin-top: 10px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__subtitle {\r\n\tfont-weight: 400;\r\n\tfont-size: 16px;\r\n\tline-height: 20px;\r\n\tpadding-top: 8px;\r\n}\r\n.mint__container {\r\n\tmargin: 32px 0;\r\n\tpadding: 12px 0;\r\n}\r\n.mint__img {\r\n\twidth: 112px;\r\n\tborder-radius: 10px;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n}\r\n.mint__text-container {\r\n\tfloat: right;\r\n\ttext-align: right;\r\n\tdisplay: block;\r\n}\r\n.mint__price-text {\r\n\tdisplay: block;\r\n\tfont-weight: 400;\r\n\tfont-size: 16px;\r\n\tline-height: 20px;\r\n\tmargin-bottom: 10px;\r\n}\r\n.mint__price {\r\n\tdisplay: block;\r\n\tfont-size: 22px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__public-sale {\r\n\tdisplay: block;\r\n\tfont-weight: 400;\r\n\tfont-size: 15px;\r\n\tline-height: 20px;\r\n\tpadding-top: 8px;\r\n\tmargin-bottom: 10px;\r\n}\r\n.mint__number {\r\n\tpadding: 8px 10px;\r\n\twidth: 100%;\r\n\tborder-radius: 10px;\r\n\tbackground-color: #262727;\r\n\tmargin-bottom: 32px;\r\n}\r\n.mint__btn-minus,\r\n.mint__btn-plus {\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tpadding: 10px;\r\n\tcursor: pointer;\r\n  background: none;\r\n  border: none;\r\n}\r\n.icon-plus,\r\n.icon-minus {\r\n\tcolor: #fff;\r\n\tfont-size: 17px;\r\n}\r\n.mint__input-price {\r\n\t-webkit-appearance: none;\r\n\tmargin: 0;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tmargin: 0 15px;\r\n\tmargin-right: 6px;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 700;\r\n\tmargin-left: 12px;\r\n\tcolor: #fff;\r\n\tbackground-color: transparent;\r\n\tborder: none;\r\n\ttext-align: center;\r\n  max-width: 100px;\r\n}\r\n.mint__max {\r\n\tborder: none;\r\n\tbackground-color: transparent;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 700;\r\n\tcolor: #fff;\r\n\tfont-family: lexend deca, sans-serif;\r\n\tfloat: right;\r\n\tpadding: 10px;\r\n\tcursor: pointer;\r\n}\r\n.mint__total {\r\n\tpadding: 20px 0;\r\n\tborder-top: 1px solid #fff;\r\n\tborder-bottom: 1px solid #fff;\r\n\theight: 65px;\r\n}\r\n.mint__total-title {\r\n\tdisplay: inline-block;\r\n\tmargin-top: 2px;\r\n\tletter-spacing: 2.5px;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 400;\r\n}\r\n.mint__total-price {\r\n\tfloat: right;\r\n\tfont-size: 22px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__btn {\r\n\tposition: relative;\r\n\ttext-transform: uppercase;\r\n\tcolor: #fff;\r\n\tborder: none;\r\n\tbackground: linear-gradient(142deg, #6c6c6c 0%, #930005 100%);\r\n\tborder-radius: 10px;\r\n\tpadding: 14px 15px;\r\n\tfont-weight: 700;\r\n\tmargin-top: 30px;\r\n\twidth: 100%;\r\n\tfont-size: 24px;\r\n\tline-height: 30px;\r\n\tcursor: pointer;\r\n\tdisplay: inline-block;\r\n\t-webkit-transition: 0.3s;\r\n\ttransition: 0.3s;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\nbutton:disabled,\r\nbutton[disabled] {\r\n  cursor: not-allowed;\r\n}\r\n.mint__btn:hover::after {\r\n\topacity: 0.7;\r\n}\r\n.btn__hide {\r\n\tdisplay: none;\r\n}\r\n.btn__hide::after {\r\n\tcontent: \"MINT\";\r\n}\r\n@media only screen and (min-width: 120px) and (max-width: 1024px) {\r\n\t.container .wrapper {\r\n\t\tpadding: 0 15px;\r\n\t}\r\n\t.mint {\r\n\t\tpadding: 23px;\r\n\t}\r\n\t.mint__container {\r\n\t\ttext-align: center;\r\n\t}\r\n\t.mint__img {\r\n\t\tmargin-bottom: 35px;\r\n\t}\r\n\t.mint__text-container {\r\n\t\tfloat: none;\r\n\t\ttext-align: center;\r\n\t}\r\n\t.mint__input-price {\r\n\t\tmargin-right: 15px;\r\n\t}\r\n}\r\n.full-screen video {\r\n\tposition: fixed;\r\n\tleft: 0;\r\n\ttop: 0;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tobject-fit: cover;\r\n\tz-index: -1;\r\n}\r\n.flex {\r\n  display: flex;\r\n}\r\n.justify-center {\r\n  justify-content: center;\r\n}\r\n.items-center {\r\n  align-items: center;\r\n}\r\n.mx-3 {\r\n  margin-left: 0.75rem/* 12px */;\r\n  margin-right: 0.75rem/* 12px */;\r\n}\r\n@keyframes spin {\r\n  to {\r\n    transform: rotate(360deg);\r\n  }\r\n}\r\n.animate-spin {\r\n  animation: spin 1s linear infinite;\r\n}\r\n.rounded-full {\r\n  border-radius: 9999px;\r\n}\r\n.h-8 {\r\n  height: 2rem;\r\n}\r\n.w-8 {\r\n  width: 2rem;\r\n}\r\n.border-b-2 {\r\n  border-bottom: 2px solid;\r\n}\r\n.border-red-700 {\r\n  border-color: #1be8ec;\r\n}", "",{"version":3,"sources":["webpack://./src/app.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;CAiFC,SAAS;CACT,UAAU;CACV,SAAS;CACT,eAAe;CACf,aAAa;CACb,wBAAwB;AACzB;AACA;CACC,WAAW;CACX,eAAe;AAChB;AACA;;;;;;;;;;;CAWC,cAAc;AACf;AACA;CACC,cAAc;EACb,eAAe;AACjB;AACA;;CAEC,gBAAgB;AACjB;AACA;;CAEC,YAAY;AACb;AACA;;;;CAIC,WAAW;CACX,aAAa;AACd;AACA;CACC,yBAAyB;CACzB,iBAAiB;AAClB;AACA;CACC,8BAA8B;CAC9B,sBAAsB;AACvB;AACA;;CAEC,8BAA8B;CAC9B,sBAAsB;AACvB;AACA;CACC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;CAChB,mBAAmB;AACpB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;CACC,eAAe;CACf,iBAAiB;AAClB;AACA;CACC,eAAe;CACf,iBAAiB;AAClB;AACA;CACC,qBAAqB;CACrB,4CAA4C;CAC5C;;;;4DAI2D;CAC3D,gBAAgB;CAChB,kBAAkB;AACnB;AACA;;CAEC,qBAAqB;CACrB,qBAAqB;CACrB,sBAAsB;CACtB,cAAc;CACd,gBAAgB;CAChB,kBAAkB;CAClB,WAAW;CACX,wBAAwB;CACxB,kBAAkB;CAClB,oBAAoB;CACpB,kCAAkC;CAClC,mCAAmC;CACnC,kCAAkC;AACnC;AACA;CACC,gBAAgB;AACjB;AACA;CACC,gBAAgB;AACjB;AACA;CACC,gBAAgB;AACjB;AACA;CACC,gBAAgB;AACjB;AACA;CACC,gBAAgB;AACjB;AACA;;;;CAIC,WAAW;CACX,cAAc;AACf;AACA;;CAEC,WAAW;AACZ;AACA;CACC,WAAW;CACX,iBAAiB;CACjB,eAAe;CACf,cAAc;AACf;AACA;CACC,4BAA4B;CAC5B,sBAAsB;CACtB,kCAAkC;AACnC;AACA;CACC,oBAAoB;CACpB,yCAAyC;CACzC,wCAAwC;CACxC,gCAAgC;CAChC,sBAAsB;CACtB,uBAAuB;CACvB,2BAA2B;CAC3B,qBAAqB;CACrB,6BAA6B;CAC7B,qBAAqB;CACrB,8BAA8B;AAC/B;AACA;;CAEC,qBAAqB;CACrB,kCAAkC;CAClC,0BAA0B;CAC1B,uBAAuB;CACvB,uBAAuB;CACvB,4BAA4B;CAC5B,sBAAsB;CACtB,8BAA8B;AAC/B;AACA;CACC,SAAS;CACT,UAAU;CACV,oCAAoC;CACpC,gBAAgB;CAChB,kBAAkB;CAClB,aAAa;CACb,YAAY;CACZ,WAAW;AACZ;AACA;CACC;EACC,aAAa;CACd;AACD;AACA;CACC,WAAW;CACX,kBAAkB;CAClB,WAAW;CACX,YAAY;CACZ,oCAAoC;CACpC,WAAW;AACZ;AACA;CACC,WAAW;AACZ;AACA;CACC,qBAAqB;AACtB;AACA;CACC,kBAAkB;CAClB,kBAAkB;CAClB,QAAQ;CACR,SAAS;CACT,wCAAwC;CACxC,gCAAgC;CAChC,WAAW;AACZ;AACA;CACC,YAAY;CACZ,mBAAmB;AACpB;AACA;CACC,cAAc;CACd,qBAAqB;CACrB,sBAAsB;AACvB;AACA;CACC,qBAAqB;CACrB,YAAY;AACb;AACA;CACC,YAAY;AACb;AACA;;CAEC,eAAe;CACf,iBAAiB;CACjB,WAAW;AACZ;AACA;CACC,cAAc;CACd,gBAAgB;CAChB,oCAAoC;CACpC,mCAAmC;CACnC,2BAA2B;CAC3B,mBAAmB;CACnB,gBAAgB;CAChB,aAAa;AACd;AACA;CACC,eAAe;CACf,iBAAiB;CACjB,gBAAgB;CAChB,gBAAgB;AACjB;AACA;CACC,gBAAgB;CAChB,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;CACC,cAAc;CACd,eAAe;AAChB;AACA;CACC,YAAY;CACZ,mBAAmB;CACnB,qBAAqB;CACrB,sBAAsB;AACvB;AACA;CACC,YAAY;CACZ,iBAAiB;CACjB,cAAc;AACf;AACA;CACC,cAAc;CACd,gBAAgB;CAChB,eAAe;CACf,iBAAiB;CACjB,mBAAmB;AACpB;AACA;CACC,cAAc;CACd,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;CACC,cAAc;CACd,gBAAgB;CAChB,eAAe;CACf,iBAAiB;CACjB,gBAAgB;CAChB,mBAAmB;AACpB;AACA;CACC,iBAAiB;CACjB,WAAW;CACX,mBAAmB;CACnB,yBAAyB;CACzB,mBAAmB;AACpB;AACA;;CAEC,qBAAqB;CACrB,sBAAsB;CACtB,aAAa;CACb,eAAe;EACd,gBAAgB;EAChB,YAAY;AACd;AACA;;CAEC,WAAW;CACX,eAAe;AAChB;AACA;CACC,wBAAwB;CACxB,SAAS;CACT,qBAAqB;CACrB,sBAAsB;CACtB,cAAc;CACd,iBAAiB;CACjB,eAAe;CACf,iBAAiB;CACjB,gBAAgB;CAChB,iBAAiB;CACjB,WAAW;CACX,6BAA6B;CAC7B,YAAY;CACZ,kBAAkB;EACjB,gBAAgB;AAClB;AACA;CACC,YAAY;CACZ,6BAA6B;CAC7B,eAAe;CACf,iBAAiB;CACjB,gBAAgB;CAChB,WAAW;CACX,oCAAoC;CACpC,YAAY;CACZ,aAAa;CACb,eAAe;AAChB;AACA;CACC,eAAe;CACf,0BAA0B;CAC1B,6BAA6B;CAC7B,YAAY;AACb;AACA;CACC,qBAAqB;CACrB,eAAe;CACf,qBAAqB;CACrB,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;CACC,YAAY;CACZ,eAAe;CACf,iBAAiB;CACjB,gBAAgB;AACjB;AACA;CACC,kBAAkB;CAClB,yBAAyB;CACzB,WAAW;CACX,YAAY;CACZ,6DAA6D;CAC7D,mBAAmB;CACnB,kBAAkB;CAClB,gBAAgB;CAChB,gBAAgB;CAChB,WAAW;CACX,eAAe;CACf,iBAAiB;CACjB,eAAe;CACf,qBAAqB;CACrB,wBAAwB;CACxB,gBAAgB;EACf,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;AACA;;EAEE,mBAAmB;AACrB;AACA;CACC,YAAY;AACb;AACA;CACC,aAAa;AACd;AACA;CACC,eAAe;AAChB;AACA;CACC;EACC,eAAe;CAChB;CACA;EACC,aAAa;CACd;CACA;EACC,kBAAkB;CACnB;CACA;EACC,mBAAmB;CACpB;CACA;EACC,WAAW;EACX,kBAAkB;CACnB;CACA;EACC,kBAAkB;CACnB;AACD;AACA;CACC,eAAe;CACf,OAAO;CACP,MAAM;CACN,WAAW;CACX,YAAY;CACZ,iBAAiB;CACjB,WAAW;AACZ;AACA;EACE,aAAa;AACf;AACA;EACE,uBAAuB;AACzB;AACA;EACE,mBAAmB;AACrB;AACA;EACE,8BAA8B;EAC9B,+BAA+B;AACjC;AACA;EACE;IACE,yBAAyB;EAC3B;AACF;AACA;EACE,kCAAkC;AACpC;AACA;EACE,qBAAqB;AACvB;AACA;EACE,YAAY;AACd;AACA;EACE,WAAW;AACb;AACA;EACE,wBAAwB;AAC1B;AACA;EACE,qBAAqB;AACvB","sourcesContent":["html,\r\nbody,\r\ndiv,\r\nspan,\r\napplet,\r\nobject,\r\niframe,\r\nh1,\r\nh2,\r\nh3,\r\nh4,\r\nh5,\r\nh6,\r\np,\r\nblockquote,\r\npre,\r\na,\r\nabbr,\r\nacronym,\r\naddress,\r\nbig,\r\ncite,\r\ncode,\r\ndel,\r\ndfn,\r\nem,\r\nimg,\r\nins,\r\nkbd,\r\nq,\r\ns,\r\nsamp,\r\nsmall,\r\nstrike,\r\nstrong,\r\nsub,\r\nsup,\r\ntt,\r\nvar,\r\nb,\r\nu,\r\ni,\r\ncenter,\r\ndl,\r\ndt,\r\ndd,\r\nol,\r\nul,\r\nli,\r\nfieldset,\r\nform,\r\nlabel,\r\nlegend,\r\ntable,\r\ncaption,\r\ntbody,\r\ntfoot,\r\nthead,\r\ntr,\r\nth,\r\ntd,\r\narticle,\r\naside,\r\ncanvas,\r\ndetails,\r\nembed,\r\nfigure,\r\nfigcaption,\r\nfooter,\r\nheader,\r\nhgroup,\r\nmenu,\r\nnav,\r\noutput,\r\nruby,\r\nsection,\r\nsummary,\r\ntime,\r\nmark,\r\naudio,\r\nvideo {\r\n\tmargin: 0;\r\n\tpadding: 0;\r\n\tborder: 0;\r\n\tfont-size: 100%;\r\n\tfont: inherit;\r\n\tvertical-align: baseline;\r\n}\r\n::selection {\r\n\tcolor: none;\r\n\tbackground: 0 0;\r\n}\r\narticle,\r\naside,\r\ndetails,\r\nfigcaption,\r\nfigure,\r\nfooter,\r\nheader,\r\nhgroup,\r\nmenu,\r\nnav,\r\nsection {\r\n\tdisplay: block;\r\n}\r\nbody {\r\n\tline-height: 1;\r\n  max-width: 100%;\r\n}\r\nol,\r\nul {\r\n\tlist-style: none;\r\n}\r\nblockquote,\r\nq {\r\n\tquotes: none;\r\n}\r\nblockquote:before,\r\nblockquote:after,\r\nq:before,\r\nq:after {\r\n\tcontent: \"\";\r\n\tcontent: none;\r\n}\r\ntable {\r\n\tborder-collapse: collapse;\r\n\tborder-spacing: 0;\r\n}\r\n* {\r\n\t-webkit-box-sizing: border-box;\r\n\tbox-sizing: border-box;\r\n}\r\n*::before,\r\n*::after {\r\n\t-webkit-box-sizing: border-box;\r\n\tbox-sizing: border-box;\r\n}\r\n.section-title {\r\n\tfont-size: 32px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.h1,\r\nh1 {\r\n\tfont-size: 68px;\r\n\tline-height: 81px;\r\n\tfont-weight: 700;\r\n\tletter-spacing: 1px;\r\n}\r\n.h2,\r\nh2 {\r\n\tfont-size: 75px;\r\n\tline-height: 82px;\r\n\tfont-weight: 700;\r\n}\r\n.h3,\r\nh3 {\r\n\tfont-size: 28px;\r\n\tline-height: 34px;\r\n\tfont-weight: 700;\r\n}\r\n.h4,\r\nh4 {\r\n\tfont-size: 23px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.h5,\r\nh5 {\r\n\tfont-size: 18px;\r\n\tline-height: 24px;\r\n\tfont-weight: 700;\r\n}\r\n.h6,\r\nh6 {\r\n\tfont-size: 14px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\np {\r\n\tfont-size: 14px;\r\n\tline-height: 22px;\r\n}\r\n.text-small {\r\n\tfont-size: 12px;\r\n\tline-height: 20px;\r\n}\r\n@font-face {\r\n\tfont-family: iconfont;\r\n\tsrc: url(./fonts/iconfont.eot?1644181909038);\r\n\tsrc: url(./fonts/iconfont.eot?#iefix-1644181909038)\r\n\t\t\tformat(\"embedded-opentype\"),\r\n\t\turl(./fonts/iconfont.woff2?1644181909038) format(\"woff2\"),\r\n\t\turl(./fonts/iconfont.woff?1644181909038) format(\"woff\"),\r\n\t\turl(./fonts/iconfont.ttf?1644181909038) format(\"truetype\");\r\n\tfont-weight: 400;\r\n\tfont-style: normal;\r\n}\r\n[class^=\"icon-\"]::before,\r\n[class*=\" icon-\"]::before {\r\n\tfont-family: iconfont;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tline-height: 1;\r\n\tfont-weight: 400;\r\n\tfont-style: normal;\r\n\tspeak: none;\r\n\ttext-decoration: inherit;\r\n\tfont-size: inherit;\r\n\ttext-transform: none;\r\n\ttext-rendering: optimizeLegibility;\r\n\t-webkit-font-smoothing: antialiased;\r\n\t-moz-osx-font-smoothing: grayscale;\r\n}\r\n.icon-discord::before {\r\n\tcontent: \"\\ea01\";\r\n}\r\n.icon-minus::before {\r\n\tcontent: \"\\ea02\";\r\n}\r\n.icon-plus::before {\r\n\tcontent: \"\\ea03\";\r\n}\r\n.icon-twitter::before {\r\n\tcontent: \"\\ea04\";\r\n}\r\n.icon-instagram::before {\r\n\tcontent: \"\\ea04\";\r\n}\r\n.mint__container::before,\r\n.mint__number::before,\r\n.mint__container::after,\r\n.mint__number::after {\r\n\tcontent: \"\";\r\n\tdisplay: table;\r\n}\r\n.mint__container::after,\r\n.mint__number::after {\r\n\tclear: both;\r\n}\r\n.wrapper {\r\n\twidth: 100%;\r\n\tmax-width: 1065px;\r\n\tpadding: 0 20px;\r\n\tmargin: 0 auto;\r\n}\r\n.has-cover {\r\n\tbackground-repeat: no-repeat;\r\n\tbackground-size: cover;\r\n\tbackground-position: center center;\r\n}\r\n.sr-only {\r\n\tborder: 0 !important;\r\n\tclip: rect(1px, 1px, 1px, 1px) !important;\r\n\t-webkit-clip-path: inset(50%) !important;\r\n\tclip-path: inset(50%) !important;\r\n\theight: 1px !important;\r\n\tmargin: -1px !important;\r\n\toverflow: hidden !important;\r\n\tpadding: 0 !important;\r\n\tposition: absolute !important;\r\n\twidth: 1px !important;\r\n\twhite-space: nowrap !important;\r\n}\r\n.sr-only-focusable:focus,\r\n.sr-only-focusable:active {\r\n\tclip: auto !important;\r\n\t-webkit-clip-path: none !important;\r\n\tclip-path: none !important;\r\n\theight: auto !important;\r\n\tmargin: auto !important;\r\n\toverflow: visible !important;\r\n\twidth: auto !important;\r\n\twhite-space: normal !important;\r\n}\r\nbody {\r\n\tmargin: 0;\r\n\tpadding: 0;\r\n\tfont-family: lexend deca, sans-serif;\r\n\tfont-weight: 400;\r\n\tposition: relative;\r\n\theight: 100vh;\r\n\twidth: 100vw;\r\n\tcolor: #fff;\r\n}\r\n@media only screen and (min-width: 120px) and (max-width: 767px) {\r\n\tbody {\r\n\t\theight: 130vh;\r\n\t}\r\n}\r\nbody::after {\r\n\tcontent: \"\";\r\n\tposition: absolute;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tbackground-color: rgba(0, 0, 0, 0.6);\r\n\tz-index: -1;\r\n}\r\np {\r\n\tcolor: #000;\r\n}\r\n[class*=\"icon-\"] {\r\n\tdisplay: inline-block;\r\n}\r\n.container {\r\n\ttext-align: center;\r\n\tposition: absolute;\r\n\ttop: 50%;\r\n\tleft: 50%;\r\n\t-webkit-transform: translate(-50%, -50%);\r\n\ttransform: translate(-50%, -50%);\r\n\twidth: 100%;\r\n}\r\n.container__list {\r\n\tfont-size: 0;\r\n\tmargin-bottom: 20px;\r\n}\r\n.container__list-item {\r\n\tmargin: 0 10px;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n}\r\n.container__list-link {\r\n\tdisplay: inline-block;\r\n\tpadding: 3px;\r\n}\r\n.container__list-img {\r\n\theight: 30px;\r\n}\r\n.icon-twitter,\r\n.icon-discord {\r\n\tfont-size: 30px;\r\n\tline-height: 35px;\r\n\tcolor: #fff;\r\n}\r\n.mint {\r\n\tmargin: 0 auto;\r\n\ttext-align: left;\r\n\tbackground-color: rgba(0, 0, 0, 0.5);\r\n\t-webkit-backdrop-filter: blur(16px);\r\n\tbackdrop-filter: blur(16px);\r\n\tborder-radius: 10px;\r\n\tmax-width: 425px;\r\n\tpadding: 32px;\r\n}\r\n.mint__title {\r\n\tfont-size: 32px;\r\n\tline-height: 35px;\r\n\tmargin-top: 10px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__subtitle {\r\n\tfont-weight: 400;\r\n\tfont-size: 16px;\r\n\tline-height: 20px;\r\n\tpadding-top: 8px;\r\n}\r\n.mint__container {\r\n\tmargin: 32px 0;\r\n\tpadding: 12px 0;\r\n}\r\n.mint__img {\r\n\twidth: 112px;\r\n\tborder-radius: 10px;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n}\r\n.mint__text-container {\r\n\tfloat: right;\r\n\ttext-align: right;\r\n\tdisplay: block;\r\n}\r\n.mint__price-text {\r\n\tdisplay: block;\r\n\tfont-weight: 400;\r\n\tfont-size: 16px;\r\n\tline-height: 20px;\r\n\tmargin-bottom: 10px;\r\n}\r\n.mint__price {\r\n\tdisplay: block;\r\n\tfont-size: 22px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__public-sale {\r\n\tdisplay: block;\r\n\tfont-weight: 400;\r\n\tfont-size: 15px;\r\n\tline-height: 20px;\r\n\tpadding-top: 8px;\r\n\tmargin-bottom: 10px;\r\n}\r\n.mint__number {\r\n\tpadding: 8px 10px;\r\n\twidth: 100%;\r\n\tborder-radius: 10px;\r\n\tbackground-color: #262727;\r\n\tmargin-bottom: 32px;\r\n}\r\n.mint__btn-minus,\r\n.mint__btn-plus {\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tpadding: 10px;\r\n\tcursor: pointer;\r\n  background: none;\r\n  border: none;\r\n}\r\n.icon-plus,\r\n.icon-minus {\r\n\tcolor: #fff;\r\n\tfont-size: 17px;\r\n}\r\n.mint__input-price {\r\n\t-webkit-appearance: none;\r\n\tmargin: 0;\r\n\tdisplay: inline-block;\r\n\tvertical-align: middle;\r\n\tmargin: 0 15px;\r\n\tmargin-right: 6px;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 700;\r\n\tmargin-left: 12px;\r\n\tcolor: #fff;\r\n\tbackground-color: transparent;\r\n\tborder: none;\r\n\ttext-align: center;\r\n  max-width: 100px;\r\n}\r\n.mint__max {\r\n\tborder: none;\r\n\tbackground-color: transparent;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 700;\r\n\tcolor: #fff;\r\n\tfont-family: lexend deca, sans-serif;\r\n\tfloat: right;\r\n\tpadding: 10px;\r\n\tcursor: pointer;\r\n}\r\n.mint__total {\r\n\tpadding: 20px 0;\r\n\tborder-top: 1px solid #fff;\r\n\tborder-bottom: 1px solid #fff;\r\n\theight: 65px;\r\n}\r\n.mint__total-title {\r\n\tdisplay: inline-block;\r\n\tmargin-top: 2px;\r\n\tletter-spacing: 2.5px;\r\n\tfont-size: 18px;\r\n\tline-height: 20px;\r\n\tfont-weight: 400;\r\n}\r\n.mint__total-price {\r\n\tfloat: right;\r\n\tfont-size: 22px;\r\n\tline-height: 25px;\r\n\tfont-weight: 700;\r\n}\r\n.mint__btn {\r\n\tposition: relative;\r\n\ttext-transform: uppercase;\r\n\tcolor: #fff;\r\n\tborder: none;\r\n\tbackground: linear-gradient(142deg, #6c6c6c 0%, #930005 100%);\r\n\tborder-radius: 10px;\r\n\tpadding: 14px 15px;\r\n\tfont-weight: 700;\r\n\tmargin-top: 30px;\r\n\twidth: 100%;\r\n\tfont-size: 24px;\r\n\tline-height: 30px;\r\n\tcursor: pointer;\r\n\tdisplay: inline-block;\r\n\t-webkit-transition: 0.3s;\r\n\ttransition: 0.3s;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\nbutton:disabled,\r\nbutton[disabled] {\r\n  cursor: not-allowed;\r\n}\r\n.mint__btn:hover::after {\r\n\topacity: 0.7;\r\n}\r\n.btn__hide {\r\n\tdisplay: none;\r\n}\r\n.btn__hide::after {\r\n\tcontent: \"MINT\";\r\n}\r\n@media only screen and (min-width: 120px) and (max-width: 1024px) {\r\n\t.container .wrapper {\r\n\t\tpadding: 0 15px;\r\n\t}\r\n\t.mint {\r\n\t\tpadding: 23px;\r\n\t}\r\n\t.mint__container {\r\n\t\ttext-align: center;\r\n\t}\r\n\t.mint__img {\r\n\t\tmargin-bottom: 35px;\r\n\t}\r\n\t.mint__text-container {\r\n\t\tfloat: none;\r\n\t\ttext-align: center;\r\n\t}\r\n\t.mint__input-price {\r\n\t\tmargin-right: 15px;\r\n\t}\r\n}\r\n.full-screen video {\r\n\tposition: fixed;\r\n\tleft: 0;\r\n\ttop: 0;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tobject-fit: cover;\r\n\tz-index: -1;\r\n}\r\n.flex {\r\n  display: flex;\r\n}\r\n.justify-center {\r\n  justify-content: center;\r\n}\r\n.items-center {\r\n  align-items: center;\r\n}\r\n.mx-3 {\r\n  margin-left: 0.75rem/* 12px */;\r\n  margin-right: 0.75rem/* 12px */;\r\n}\r\n@keyframes spin {\r\n  to {\r\n    transform: rotate(360deg);\r\n  }\r\n}\r\n.animate-spin {\r\n  animation: spin 1s linear infinite;\r\n}\r\n.rounded-full {\r\n  border-radius: 9999px;\r\n}\r\n.h-8 {\r\n  height: 2rem;\r\n}\r\n.w-8 {\r\n  width: 2rem;\r\n}\r\n.border-b-2 {\r\n  border-bottom: 2px solid;\r\n}\r\n.border-red-700 {\r\n  border-color: #1be8ec;\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
if (true) {
  if (!_css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals || module.hot.invalidate) {
  ...
  return true;
    ...
    var isNamedExport = !_css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;
    var oldLocals = isNamedExport ? _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__ : _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

    module.hot.accept(
      /*! !!../../css-loader/dist/cjs.js!./toastify.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/toastify-js/src/toastify.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js!./toastify.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/toastify-js/src/toastify.css");
(function () {
        if (!isEqualLocals(oldLocals, isNamedExport ? _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__ : _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals, isNamedExport)) {
                module.hot.invalidate();

                return;
              }

              oldLocals = isNamedExport ? _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__ : _css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

              update(_css_loader_dist_cjs_js_toastify_css__WEBPACK_IMPORTED_MODULE_6__["default"]);
...
"use strict";
module.exports = __webpack_require__.p + "557f3bc123d34202e1da.eot";

/***/ }),

/***/ "./src/fonts/iconfont.eot?1644181909038":
/*!**********************************************!*\
  !*** ./src/fonts/iconfont.eot?1644181909038 ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "557f3bc123d34202e1da.eot?1644181909038";

/***/ }),

/***/ "./src/fonts/iconfont.ttf?1644181909038":
/*!**********************************************!*\
  !*** ./src/fonts/iconfont.ttf?1644181909038 ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "5074416b6e5b5d035c62.ttf?1644181909038";

/***/ }),

/***/ "./src/fonts/iconfont.woff2?1644181909038":
/*!************************************************!*\
  !*** ./src/fonts/iconfont.woff2?1644181909038 ***!
  \************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "da9cdd0257e9c091cb0b.woff2?1644181909038";

/***/ }),

/***/ "./src/fonts/iconfont.woff?1644181909038":
/*!***********************************************!*\
  !*** ./src/fonts/iconfont.woff?1644181909038 ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "7ea3a66545b3f696ac97.woff?1644181909038";
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("122797f158f66260d4c5")
/******/ 	})();
/******/ 	
